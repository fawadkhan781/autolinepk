      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 text-left">
            <h3 style="text-transform: capitalize;"><?=$titlefinal;?> Page</h3>
          </div>    
